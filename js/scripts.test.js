...
const { toggleCamera, requestTranslation, captureFrame } = require("./scripts");
...
test("toggleCamera starts and stops the webcam", async () => {
    // Mock webcam stream
    const mockStream = { // Generic javascript object
        getTracks: () => [{ // Inline instance method returns an array of one generic object
